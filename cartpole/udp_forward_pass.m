function [us,xs] = udp_forward_pass(x0,f,Ks,ds, xnom, unom)
% Syntax: 
%    [us,xs] = udp_forward_pass(x0,f,Ks,ds, xnom, unom)
%
% In:
...
%
% Description:
%   Compute UDP forward pass corresponding to udp_backward_pass.
