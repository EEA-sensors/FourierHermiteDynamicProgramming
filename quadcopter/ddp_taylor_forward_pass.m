function [us,xs] = ddp_taylor_forward_pass(x0,f,Ks,ds, xnom, unom)
% Syntax: 
%    [us,xs] = ddp_taylor_forward_pass(x0,f,Ks,ds, xnom, unom)
%
% In:
...
%   xnom - nominal trajectory
%   unom - nominal control
% Out:
%   us - Optimal controls for k=0,...,T-1 as vectors udim * T
%   xs - Optimal states for k=0,...,T as vectors xdim * (T+1)
%
% Description:
%   Compute DDP forward pass corresponding to ddp_taylor_backward_pass.
